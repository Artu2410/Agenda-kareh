...
const DashboardPage = () => {
  ...
  return (
    <div className="w-full h-full overflow-auto bg-slate-50 p-4 sm:p-8 flex flex-col gap-6 sm:gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* SEMANAL */}
        <div className="bg-white p-5 sm:p-8 rounded-[2rem] border shadow-sm">
          ...
          <p className="text-4xl sm:text-5xl font-black text-slate-800">{metrics.weekly?.total || 0}</p>
        ...
        <div className="bg-white p-5 sm:p-8 rounded-[2rem] border shadow-sm">
          ...
          <p className="text-4xl sm:text-5xl font-black text-slate-800">{metrics.monthly?.current || 0}</p>
        ...
        <div className="bg-white p-5 sm:p-8 rounded-[2rem] border shadow-sm">
          ...
          <p className="text-4xl sm:text-5xl font-black text-slate-800">{metrics.annual?.patientCount || 0}</p>
      ...
      <div className="bg-white p-5 sm:p-8 rounded-[2rem] border shadow-sm flex-1">
