...
import { BarChart3, Calendar, Users, DollarSign, Settings, FileText, LogOut, MessageCircle, ScanText } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: ScanText, label: 'Transcripción', path: APP_ROUTES.transcription },
