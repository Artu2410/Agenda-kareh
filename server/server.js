...
app.get('/api/whatsapp-config', (req, res) => {
  const config = {
    ...
    welcomeMode: process.env.WHATSAPP_WELCOME_MODE || 'text',
    holaMode: process.env.WHATSAPP_HOLA_MODE || 'text',
    greetingTemplateEnabled: String(process.env.WHATSAPP_GREETING_TEMPLATE_ENABLED || 'false').trim().toLowerCase() === 'true',
    greetingTextFromEnv: String(process.env.WHATSAPP_GREETING_TEXT_FROM_ENV || 'false').trim().toLowerCase() === 'true',
