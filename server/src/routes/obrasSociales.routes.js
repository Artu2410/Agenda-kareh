...
const createRouter = (prisma) => {
  ...
  router.get('/coinsurance-report', checkRole('SUPER_USER', 'ADMIN'), (req, res) => getCoinsuranceReport(req, res, prisma));
  ...
  router.post('/sync', checkRole('SUPER_USER', 'ADMIN'), (req, res) => syncObrasSociales(req, res, prisma));
