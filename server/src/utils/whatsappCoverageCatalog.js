...
const INITIAL_COVERAGES = [
  ...
  { name: 'IOSFA', aliases: [], isActive: false, documentationRequired: 'Cobertura suspendida' },
  ...
  { name: 'OSDE', aliases: [], isActive: false, documentationRequired: 'No trabajamos esta cobertura' },
  ...
  { name: 'COBERTURA_PRIVADA ART', aliases: ['Cobertura Privada', 'Cobertura Privada Art'], isActive: true, documentationRequired: ART_DOCUMENTATION },
